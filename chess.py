...
class Chess(object):
    ...
    def reset(self):
        ...
        #piece_name, currently_selected, x_y_coordinate
        self.piece_location = {}
        x = 0
    ...
    def play_turn(self):
        ...
        # player with black piece
        if(self.turn["black"]):
            self.move_piece("black")
        # player with white piece
        elif(self.turn["white"]):
    ...
    def possible_moves(self, piece_name, piece_coord):
        # store possible moves of the selected piece
        positions = []
